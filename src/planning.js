  ...
  root.innerHTML = `
    <section class="plan-section" aria-label="Trip planner">
      ...
      <div class="plan-tabs" style="display: flex; gap: 8px; border-bottom: 2px solid var(--md-sys-color-outline-variant); margin: 16px 0 12px 0;">
        <button class="plan-tab-btn plan-tab-btn--active" data-tab="water" style="flex: 0 0 auto; padding: 10px; background: none; border: none; border-bottom: 3px solid var(--md-sys-color-primary); font-weight: 600; cursor: pointer; color: var(--md-sys-color-primary); font-size: 12px;">💧 Water</button>
        <button class="plan-tab-btn" data-tab="food" style="flex: 0 0 auto; padding: 10px; background: none; border: none; border-bottom: 3px solid transparent; font-weight: 600; cursor: pointer; color: var(--md-sys-color-on-surface-variant); font-size: 12px;">🛒 Food</button>
        <button class="plan-tab-btn" data-tab="camps" style="flex: 0 0 auto; padding: 10px; background: none; border: none; border-bottom: 3px solid transparent; font-weight: 600; cursor: pointer; color: var(--md-sys-color-on-surface-variant); font-size: 12px;">⛺ Camps</button>
        <button class="plan-tab-btn" data-tab="analytics" style="flex: 0 0 auto; padding: 10px; background: none; border: none; border-bottom: 3px solid transparent; font-weight: 600; cursor: pointer; color: var(--md-sys-color-on-surface-variant); font-size: 12px;">📊 Analytics</button>
        <button class="plan-tab-btn" data-tab="checklists" style="flex: 0 0 auto; padding: 10px; background: none; border: none; border-bottom: 3px solid transparent; font-weight: 600; cursor: pointer; color: var(--md-sys-color-on-surface-variant); font-size: 12px;">🎒 Checklists</button>
        <button class="plan-tab-btn" data-tab="log" style="flex: 0 0 auto; padding: 10px; background: none; border: none; border-bottom: 3px solid transparent; font-weight: 600; cursor: pointer; color: var(--md-sys-color-on-surface-variant); font-size: 12px;">📋 Log</button>
        <button class="plan-tab-btn" data-tab="research" style="flex: 0 0 auto; padding: 10px; background: none; border: none; border-bottom: 3px solid transparent; font-weight: 600; cursor: pointer; color: var(--md-sys-color-on-surface-variant); font-size: 12px;">🔍 Research</button>
      </div>
